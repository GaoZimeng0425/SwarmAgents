...
import { Text, type View, type ViewStyle } from 'react-native'
...
const Tooltip = React.forwardRef<React.ComponentRef<typeof UITooltip>, ITooltipProps>(function Tooltip(
  { className, ...props },
  ref
) {
  return <UITooltip className={tooltipStyle({ class: className })} ref={ref} {...props} />
})
...
>(function TooltipText({ size, className, ...props }, ref) {
  return <UITooltip.Text className={tooltipTextStyle({ size, class: className })} ref={ref} {...props} />
})
