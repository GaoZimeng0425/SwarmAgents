...
const mcpDeps = () => ({
  ...
  researchRepo: vi.fn().mockReturnValue({ ok: true }),
  getRepoResearch: vi.fn().mockResolvedValue({ research: null, researchedAt: null }),
  researchedRepoNames: vi.fn().mockResolvedValue([]),
