...
// useHotkeys. The happy-dom env can't service the global listener cleanly, so
// we no-op the registration hooks to keep the mount focused on palette behavior.
